...
export class RegisterComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.httpSvc.post("Authenticate/Register", this.registerForm.getRawValue()).subscribe(
      response => {
  ...
  validatePassword() {
    ...
    if (
      ...
      this.registerForm.get('password')?.value != this.registerForm.get('confirmPassword')?.value ) {
        this.registerForm.get('confirmPassword')?.setErrors({confirmPasswordValidator: true});
      }
      else {
